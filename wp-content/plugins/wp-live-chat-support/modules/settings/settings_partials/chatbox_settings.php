...
<table class='wp-list-table wplc_list_table widefat fixed striped pages'>
    ...
    <tr>
        ...
        <td valign='top'>
            <input id="wplc_agent_default_name" name="wplc_agent_default_name"
    ...
    <tr class='wplc-agent-logo-area'>
        ...
        <td>
            <div style="display:block" id="wplc_agent_logo_area">
                <img id="wplc_agent_logo_preview" src="<?= trim( urldecode( $wplc_settings->wplc_agent_logo ) ); ?>" width="100px"/>
            </div>
            <input id="wplc_agent_logo" name="wplc_agent_logo" type="hidden" size="35" class="regular-text"
                   maxlength="700"
                   value="<?= base64_encode( trim( urldecode( $wplc_settings->wplc_agent_logo ) ) ); ?>"/>
