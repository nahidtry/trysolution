    ...
    <tr class='wplc_custom_pall_rows'>
        ...
        <td>
            <input id="wplc_settings_base_color" name="wplc_settings_base_color" type="color"
                   value="<?= isset( $wplc_settings->wplc_settings_base_color ) ? $wplc_settings->wplc_settings_base_color : '373737' ?>"/>
        </td>
    </tr>
    <tr class='wplc_custom_pall_rows'>
        <td width='200' valign='top'><?= __( "Buttons color", 'wp-live-chat-support' ) ?>:</td>
        <td>
            <input id="wplc_settings_button_color" name="wplc_settings_button_color" type="color"
                   value="<?= isset( $wplc_settings->wplc_settings_button_color ) ? $wplc_settings->wplc_settings_button_color : '0596d4' ?>"/>
        </td>
    </tr>
    <tr class='wplc_custom_pall_rows'>
