...
<table class="wp-list-table wplc_list_table widefat fixed striped pages">
    <tbody>
      ...
      <tr>
        ...
        <td>
          <input type="number" class="wplc-input-number" name="wplc_gdpr_notice_retention_period" min="1" max="730" step="1" value="<?= (isset($wplc_settings->wplc_gdpr_notice_retention_period) ? intval($wplc_settings->wplc_gdpr_notice_retention_period) : 30); ?>"> <?=__('days', 'wp-live-chat-support'); ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
            <textarea cols="45" rows="5" maxlength="1000" name="wplc_gdpr_notice_text"><?= wplc_gdpr_generate_retention_agreement_notice($wplc_settings,false);?></textarea>
        </td>
      </tr>
    </tbody>
  </table>